const en = {
  ...
  colors: {
    ...
    villefortBronzeSceptre: "Villefort Bronze Sceptre",
    herreraRealBurdeos: "Herrera Real Burdeos",
    archerIceArrow: "Archer Ice Arrow",
    chevillonDreadnought: "Chevillon Dreadnought",
    makigaiNanoWasabi: "Makigai Nano Wasabi",
    archAsphaltFury: "Arch Asphalt Fury",
    dodgeDragstripInferno: "Dodge Dragstrip Inferno",
    chevroletElkhartLake: "Chevrolet Elkhart Lake",
    vipers: "Vipers",
    corvettes: "Corvettes",
    militechManOWar: "Militech Man O'War",
    mahirAstonGreen: "Mahir Aston Green",
    zetatechSnowGray: "Zetatech Snow Gray",
    traumaTeamEmergency: "Trauma Team Emergency",
